...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-success text-white">Create New Bus</div>
                    <div class="card-body">
                        @if(session('error'))
                        ...
                        <form action="{{ route('bus.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="bus_number" class="form-control{{ $errors->has('bus_number') ? ' is-invalid' : '' }}" value = {{old('bus_number')}} >
                            ...
                            <div class="form-group">
                                ...
                                <select name="driver_id" class="form-control{{ $errors->has('driver_id') ? ' is-invalid' : '' }}" value = {{old('driver_id')}} >
                            ...
                            <div class="form-group">
                                ...
                                <select name="ac" class="form-control{{ $errors->has('ac') ? ' is-invalid' : '' }}" value = {{old('ac')}} >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="manufacturer" class="form-control{{ $errors->has('manufacturer') ? ' is-invalid' : '' }}" value = {{old('manufacturer')}} >
                            ...
                            <div class="form-group">
                                ...
                                <select name="manufacture_year" class="form-control{{ $errors->has('manufacture_year') ? ' is-invalid' : '' }}" value = {{old('manufacture_year')}} >
                                @php
                                    $currentYear = date('Y');
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="seating_capacity" class="form-control{{ $errors->has('seating_capacity') ? ' is-invalid' : '' }}" value = {{old('seating_capacity')}} >
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="insurance_expire_date" class="form-control{{ $errors->has('insurance_expire_date') ? ' is-invalid' : '' }}" value = {{old('insurance_expire_date')}} >
                            ...
                            <div class="form-group">
                                ...
                                <select name="fuel_type" class="form-control{{ $errors->has('fuel_type') ? ' is-invalid' : '' }}" value = {{old('fuel_type')}} >
